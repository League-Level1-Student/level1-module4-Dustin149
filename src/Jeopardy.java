...
public class Jeopardy implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (buttonPressed == firstButton) {
			...
			askQuestion("If tomorrow was today, and today was yesterday, what day is the day after tomorrow?",
					"tomorrow",500);
		...
		// If the buttonPressed was the secondButton
			...
			askQuestion("What does the amalgam of lava and water create?","cobblestone",1000);
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		String userInput = JOptionPane.showInputDialog("What is your answer?");
